...
const ItemDetailPage = () => {
    ...
    return (
        <>
            {itemData && (
                <Head>
                    <title>{itemData.title} - Explore Gallery</title>
            ...
            <div className="p-6 max-w-5xl mx-auto">
                ...
                <p className="text-gray-500 mb-4">
                    <span className="text-black font-semibold">Category:</span> {itemData.category || "N/A"}
                </p>
                <p className="text-gray-500 mb-4">
                    <span className="text-black font-semibold">Description:</span> {itemData.description || "N/A"}
                </p>
                ...
                <div className="flex justify-between items-center text-gray-600">
                    <span>
                        <span className="text-black font-semibold">Author:</span> {itemData.author || "Unknown"}
                    </span>
                    <div>
                        <button
                        ...
                        <span className="text-black font-semibold mr-2">❤️ {itemData.likes ?? 0}</span>
                    </div>
                </div>
            </div>
