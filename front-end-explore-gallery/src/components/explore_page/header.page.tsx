                        ...
                        {!is_create_page && (
                            <>
                                {!is_detail_page && (
                                    <>
                                        ...
                                        <div className="text-base md:text-lg lg:text-xl">
                                            <Search className="w-5 h-5 md:h-7 md:w-7 " onClick={handleSearchClick} />
                                        </div>
                                    </>
                                )}
                                <Link href={"/create"} className="ml-2 text-white py-1 px-3 rounded-xl bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-500 hover:to-cyan-500 transition-colors duration-300 ease-in-out flex justify-center items-center">
                                    <span className="text-xl font-light w-5 flex justify-center items-cente mr-0 md:mr-2"><PenLine className="w-5 h-5 md:h-7 md:w-7 " /></span>
                                    <span className="hidden md:block">Create New</span>
                                </Link>
                            </>
                        )}
                        <div className="flex items-center justify-start ml-2 w-5 h-5 md:h-7 md:w-7">
                            <ModeToggle />
                        </div>
